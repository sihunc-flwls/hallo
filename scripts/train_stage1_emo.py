...
from hallo.animate.face_animate_static import StaticPipeline_EMO
...
class Net(nn.Module):
    ...
    def forward(
        ...
        # model_pred = self.denoising_unet(noisy_latents,timesteps,mask_cond_fea=face_mask_feature,encoder_hidden_states=None,).sample
        ...
        for _, batch in enumerate(train_dataloader):
            with accelerator.accumulate(net):
                ...
                for _, (ref_img, face_emb) in enumerate(
                    ...
                    hidden_emb_list.append(torch.zeros_like(face_emb)) # dummy
                ...
                with torch.no_grad():
                    ...
                    hidden_emb = torch.stack(hidden_emb_list, dim=0).to(
                ...
                model_pred = net(
                    ...
                    timesteps,
                    ref_image_latents,
                    hidden_emb, # NOTE: this is a zero vector!
                    face_mask_img,
                    uncond_fwd,
                )
