...
from diffusers.loaders import PeftAdapterMixin, LoraLoaderMixin
...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin, LoraLoaderMixin):
    r"""
